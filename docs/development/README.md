...
| Document | Purpose |
|---|---|
| `docs/development/missions.md` | Defines the Engineering Mission as the executable unit of work. |
| `docs/development/change-lifecycle.md` | Defines pull request evidence, review, handoff, and mission completion. |
